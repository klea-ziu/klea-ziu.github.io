...
This is a lightweight static replacement for the current Academic Pages site.
...
To use this as the main website at `https://klea-ziu.github.io/`, place these files at the root of the `klea-ziu.github.io` repository.

Keep the existing `images/graduation.JPG` file in the repository, because the homepage uses it for the portrait.
